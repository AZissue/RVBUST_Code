...
import { IsArray, IsDateString, IsEnum, IsIn, IsOptional, IsString, IsUUID, Length } from 'class-validator';
import { TICKET_CATEGORIES } from '../../common/ticket-categories.js';
...
export class CreateTicketDto {
  ...
  @IsIn([...TICKET_CATEGORIES], { message: `问题分类无效，可选：${TICKET_CATEGORIES.join(' / ')}` }) category!: string;
