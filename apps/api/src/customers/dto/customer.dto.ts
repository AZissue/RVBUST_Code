...
import { IsBoolean, IsEnum, IsOptional, IsString, IsUrl, IsUUID, Length, ValidateIf } from 'class-validator';
...
export class CreateCustomerDto {
  ...
  @IsOptional() @IsEnum(CustomerLevel) level?: CustomerLevel;
  @IsOptional() @IsBoolean() levelLocked?: boolean;
