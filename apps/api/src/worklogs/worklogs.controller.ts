...
import { CreateWorklogDraftsDto, CreateWorklogDto, UpdateWorklogDto, ListWorklogsDto } from './dto/worklog.dto.js';
...
export class WorklogsController {
  ...
  @Get() list(@CurrentUser() user: AuthUser, @Query() query: ListWorklogsDto) { return this.worklogs.list(user, query.ticketId); }
