...
export const roleLabels: Record<Role, string> = { admin: '管理员', support: '技术支持', employee: '员工' }
...
export const loanStatusLabels: Record<LoanStatus, string> = { QUEUED: '排队中', ONGOING: '借出中', OVERDUE: '已逾期', RETURNED: '已归还', CANCELLED: '已取消' }
