...
V2 使用 React + TypeScript + NestJS + PostgreSQL + Prisma，分别管理工单（问题）、工作事项（任务）和工作记录（事实）。当前已落地：工单 ↔ 工作记录/工作事项自动联动、工单 ↔ 借测/维修联动闭环（勾选创建、双向时间线、关单拦截、通知催办、仪表盘联动待办）、设备台账/借测排队评分/返修流程、客户分级档案、日报周报月报日历、RBAC 权限与审计。

启动、环境配置、测试和部署请参阅 [README-V2.md](docs/README-V2.md)，当前实现范围见 [V2开发进度.md](docs/V2开发进度.md)。设计文档与审查报告见 [docs/](docs/) 目录，近期重点： [工单借测维修联动_20260916.md](docs/工单借测维修联动_20260916.md)、[记录循环联动_20260916.md](docs/记录循环联动_20260916.md)、[移除customer门户用户_20260916.md](docs/移除customer门户用户_20260916.md)。
